...
server:
	gcc -pthread -o TCP_Server/server TCP_Server/server.c TCP_Server/serverHandler.h TCP_Server/serverHandler.c common/socketp2p.h common/socketp2p.c TCP_Server/Client.h TCP_Server/Client.c
clean:
